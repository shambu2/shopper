  ...
  return (
    <nav>
      <div className="flex w-[90vw] mx-auto gap-2 justify-between items-center   h-20">
        <div
          className="flex items-center gap-2 h-20 cursor-pointer"
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-zinc-900 flex flex-col text-4xl font-semibold">
          <div
            className="flex items-center border-b border-gray-500 cursor-pointer"
          ...
          <div>
            <ul className="flex flex-col justify-center ">
              <li className="py-5 border-b border-gray-600 pl-10 hover:bg-white hover:text-black cursor-pointer">
                Home
              </li>
              <li className="py-5 border-b border-gray-600 pl-10 hover:bg-white hover:text-black cursor-pointer">
                Collection
